...
if typing.TYPE_CHECKING:
    from .base import LatLng, LatLngDict
    from .enums import DynamicRetrievalConfigMode
    from .external import ExternalApi, ExternalApiDict
    from .temporal import Interval, IntervalDict
