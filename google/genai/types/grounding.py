...
if typing.TYPE_CHECKING:
    from .base import Segment, SegmentDict
    from .retrieval import RagChunk, RagChunkDict, RetrievalMetadata, RetrievalMetadataDict, SearchEntryPoint
    from .retrieval import SearchEntryPointDict
