...
def _build_symbol_map():
    ...
    """
    submodules = [
        'enums', 'content', 'generation', 'safety',
        'functions', 'tools', 'auth', 'configs',
        'retrieval', 'grounding', 'embeddings', 'documents',
        'batch', 'live', 'operations', 'images', 'media', 'code',
        'tuning', 'files', 'caching', 'responses', 'parameters',
        'candidates', 'metadata', 'http', 'schema', 'external',
        'temporal', 'routing', 'thinking', 'prompts', 'metrics',
        'base',
    ]
